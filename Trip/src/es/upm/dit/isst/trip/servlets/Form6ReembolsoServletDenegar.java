...
/**
 * Servlet implementation class Form6ReembolsoServletDenegar
 */
@WebServlet("/Form6ReembolsoServletDenegar")
public class Form6ReembolsoServletDenegar extends HttpServlet {
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//Email para notificar al empleado que se ha denegado su reembolso
	    Notificacion notificacion = new Notificacion();
	    String remitente = viaje.getViajero().getSuperior().getEmail();
	    String subject = "TRIP - Reembolso denegado";
	    String msg = viaje.getViajero().getSuperior().getName() + "  " + viaje.getViajero().getSuperior().getEmail() + " ha denegado el reembolso del viaje numero " + viaje.getnViaje();
